...
<a href="manage-bookings.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really want to Cancel this Booking')"> Cancel</a>
				...
				<div class ="calform" style="margin-left: 20px; margin-bottom: 30px;">
	<form id="calculator">
    <div class="labelc">Picup meter:</div>
    <input type="number" name="num1" placeholder="picup meter" />
    <div class="labelc">Dropoff meter:</div>
    <input type="number" name="num2" placeholder="dropoff meter">
    <div class="button"><br><input type="submit" value="CALCULATE"></div><br>
</form>
...
if (isset($_GET['num1']) && isset($_GET['num2'])) {
    ...
    if ($sum <= $num3) {
        ...
        echo "<br>** In the limit **";
    } elseif ($sum>$num3) {

       echo " <br> Used extra " .$total. "Km" ;

        echo " <br> Extra Cost is ::::: ", "Rs ."  .$total1. "";
