        ...
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input id="fromdate" type="date" class="form-control" name="fromdate" placeholder="From Date(dd/mm/yyyy)" value="<?php echo date("Y-m-d"); ?>" min="<?php echo date("Y-m-d"); ?>" required>
            </div>
            <div class="form-group">
